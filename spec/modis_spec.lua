...
describe('modis', function()
  ...
  describe('Cursor', function()
    ...
    describe(':count', function()
      it('returns the number of elements in the cursor', function()
        db.even:insert({{n=2},{n=4},{n=6}})
        assert.same(db.even:find():count(), 3)
        assert.same(db.even:find():limit(2):count(), 2)
      end)
    end)
    ...
    describe('[<integer>]', function()
      ...
      it('respects the index', function()
        db.workdays:insert({{n='monday'},{n='tuesday'},{n='aurelian friday'}})
